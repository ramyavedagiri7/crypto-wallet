...
public class RESTClient{
    private static String TAG = "com.example.avengersclient.RESTClient";
    ...
    public JSONObject getJSONObj(String url) throws Exception {
        String result = get(url);
        try {
    ...
    private InputStream openURL(String url) {
        ...
        Log.i(TAG, "GET " + url);
        Log.i(TAG, "httpget " + httpget.toString());
        try {
            try {
    ...
    public static void main(String[] args){
    	...
    	String str=rest.get("http://192.168.0.101:3456/uri/URI%3ACHK%3A75dm54kilvmebxqhn2rosl75xu:45i42oxji7tx6acfagtfyqmbl3i3qsaorzdmxc6krhnitnzlilma%3A1%3A1%3A60");
		Log.i("output",str);
    }
}
